...
//   void deleteStaffInfoById(Long paramLong);
   ...
   @Update("UPDATE staff_info SET building_num = #{selectedBuilding}, floor = #{selectedFloor}, room_num = #{selectedRoom}, room_standard = #{selectedRoomStandard} WHERE building_num = #{buildingNum} AND floor = #{floor} AND room_num = #{roomNum} AND staff_name = #{staffName}")
   ...
   @Update("UPDATE staff_info SET building_num = #{selectedBuilding}, floor = #{selectedFloor}, room_num = #{selectedRoom}, room_standard = #{selectedRoomStandard}, bed_num = #{selectedBedNum} WHERE building_num = #{buildingNum} AND floor = #{floor} AND room_num = #{roomNum} AND staff_name = #{staffName}")
   void exchangeStaffRoom(ExchangeStaffRoomDTO dto);

   @Update("UPDATE staff_info SET building_num = #{buildingNum}, floor = #{floor}, room_num = #{roomNum}, room_standard = #{roomStandard}, bed_num = #{bedNum} WHERE building_num = #{selectedBuilding} AND floor = #{selectedFloor} AND room_num = #{selectedRoom} AND staff_name = #{selectedStaff}")
