...
public class Token {
     ...
     */
    private static final String APPID = "09044682-C63F-4219-94C4-C3359B6EC2F1";

    public static void main(String[] args) {
        String params = "{\"page\":1,\"pageSize\":10,\"jobTitleName\":\"\"}";
        testRestful("http://10.1.11.175","/api/hrm/resful/getJobtitleInfoWithPage",params);
    }
    // public static void main(String[] args) {
    //     // 调用testRegist方法，传入ECOLOGY系统的地址
    //     String address = "http://10.1.11.175";  // 替换成实际的地址
    //     Map<String, Object> registData = testRegist(address);

    //     // 打印返回的注册信息
    //     System.out.println("Regist Data: " + registData);
    // }
    /**
     * 第一步：
     *
